...
config.Data.unitsPerJob = 8000 #number of events per jobs # 18K FOR SINGLE ELE, 10k for others
...
config.Data.allowNonValidInputDataset = True # For samples still in production
